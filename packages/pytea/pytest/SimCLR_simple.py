...
train_loader = DataLoader(
    ...
    num_workers=4,
    shuffle=True,
    # drop_last=True  # ERROR PART 1. drop_last=True is essential
)
...
for B, E, T in hparams_settings:
    ...
    """
    ERROR PART 2. train_loader should be updated after changing the BATCH_SIZE
    train_loader = DataLoader(
        train_dataset,
        batch_size=BATCH_SIZE,
        num_workers=4,
        shuffle=True,
        # drop_last=True  # error part. drop_last=True is essential
    )
    """
