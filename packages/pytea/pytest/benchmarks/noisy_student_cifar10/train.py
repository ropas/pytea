...
parser.add_argument("--batch_size", default=256, help="batch size for training", type=int)
parser.add_argument("--batch_size_test", default=256, help="batch size for testing", type=int)
...
parser.add_argument("--teacher_num_learning_images", default=50000, help="the number of images required to train teacher", type=int)
parser.add_argument("--student_width", default=1, help="resnet width of student model", type=int)
parser.add_argument("--student_num_learning_images", default=150000, help="the number of images required to train student", type=int)
...
for teacher_layer, student_layer in zip([20, 26, 32], [26, 32, 38]):
