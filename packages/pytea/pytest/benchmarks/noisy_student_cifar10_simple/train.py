...
parser.add_argument(
    "--ratio_labeled", default=0.1, help="ratio of labeled training data", type=float
)
parser.add_argument(
...
parser.add_argument(
    "--teacher_num_learning_images",
    default=50000,
    help="the number of images required to train teacher",
    type=int,
)
parser.add_argument(
...
teacher_epochs = 1
print(
    "To learn {} images while learning, {} epochs are required".format(
        args.teacher_num_learning_images, teacher_epochs
    )
)
